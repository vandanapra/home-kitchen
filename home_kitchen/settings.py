"""
Django settings for home_kitchen project.
...
ROOT_URLCONF = 'home_kitchen.urls'
...
WSGI_APPLICATION = 'home_kitchen.wsgi.application'
...
RAZORPAY_KEY_SECRET = os.getenv('RAZORPAY_API_KEY_SECRET')
